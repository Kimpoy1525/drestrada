const CLINICS = [
  {
    ...
    image: '/senor-sto-nino-hospital.png',
    schedule: [
      ...
      <div className="container">
        ...
        <div className="clinics__list">
          {CLINICS.map((clinic, index) => {
            return (
              <article className={`clinic-card ${!clinic.image ? 'clinic-card--no-image' : ''}`} key={clinic.name}>
                ...
                {clinic.image ? <div className="clinic-card__photo"><img src={clinic.image} alt={`Exterior of ${clinic.name}`} /></div> : <div className="clinic-card__feature" aria-label="Bayambang clinic location"><span className="clinic-card__feature-mark">B</span><div><small>Serving patients in</small><strong>Bayambang</strong><p>Pangasinan</p></div><div className="clinic-card__feature-note">Compassionate adult care,<br />closer to your community.</div></div>}
              </article>
            );
          })}
        </div>
